...
//     file.flush()?;
//     println!("BMP file written successfully to {}", file_path);
//     Ok(())
// }
...
//     println!("BMP header written successfully.");
//     Ok(())
// }
...
//     println!("Pixel data written successfully.");
//     Ok(())
// }
